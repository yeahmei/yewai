...
public class VideoUtils {
     ...
     */
    public static ResponseEntity<byte[]> prepareContent(final String fileName, final String fileType, final String range) {
     ...
     */
    public static byte[] readByteRangeNew(String filename, long start, long end) throws IOException {
    ...
    public static byte[] readByteRange(String filename, long start, long end) throws IOException {
        Path path = Paths.get(getFilePath(), filename);
    ...
    private static String getFilePath() {
        URL url = VideoUtils.class.getResource(VIDEO);
        assert url != null;
